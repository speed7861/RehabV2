...
def print_banner():
    ...
    print("\n")
    print ("Based on Dark VPS's VELOCITY originally writen in python 2 ")
    print("Translated and upgraded by ight#1859 \n")
...
def help():
    ...
    print("   %s╟ %sNMAP %s- %sAdvanced Portscanner (NMAP must be installed and added to path)                  ║%s" % (fg(14),fg(1),fg(3),fg(14),attr(0)))
    print("   %s╟ %sBRUTE %s- %sBrute Mirai SQL Database to gain access (requires PyMySQL)                      ║%s" % (fg(14),fg(1),fg(3),fg(14),attr(0)))
    print("   %s╟ %sCNCKILL %s- %sAttempts to kill a Mirai CNC (requires telnetlib)                             ║%s" % (fg(14),fg(1),fg(3),fg(14),attr(0)))
    print("   %s╟ %sPW %s- %sSecure Password generator                                                          ║%s" % (fg(14),fg(1),fg(3),fg(14),attr(0)))
...
def bannergrab(ip):
    ...
    if response.status_code == 200:
        ...
        print("   %s╠hetion and try again.%s" % (fg(14),fg(3),fg(14),fg(1),fg(3),attr(0)))
def brute(ip):
    try:
        import pymysql
    except:
